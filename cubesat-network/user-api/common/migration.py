...
from constants import script_dir, DEFAULT_ADMIN_PASSWD
...
class SecureSql:
    ...
    initial_userinfo_path = "/usr/src/shared/admin_info.json"
    ...
    def createUserDB(self):
        ...
        user_id = 'admin'
        raw_password = DEFAULT_ADMIN_PASSWD # Initial admin password
    ...
    def createKeyDB(self):
        ...
        self.key_db = securesql.connect(SecureSql.key_db_path)
        ...
        print(f"Key database encryption token created.")
